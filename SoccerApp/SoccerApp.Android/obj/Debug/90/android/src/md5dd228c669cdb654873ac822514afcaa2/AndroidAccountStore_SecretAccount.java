...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Auth.AndroidAccountStore+SecretAccount, Xamarin.Auth.Android", AndroidAccountStore_SecretAccount.class, __md_methods);
	}
	...
	public AndroidAccountStore_SecretAccount ()
	{
		...
		if (getClass () == AndroidAccountStore_SecretAccount.class)
			mono.android.TypeManager.Activate ("Xamarin.Auth.AndroidAccountStore+SecretAccount, Xamarin.Auth.Android", "", this, new java.lang.Object[] {  });
	}
